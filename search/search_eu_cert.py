...
def search_eu_cert(keyword, source, results, seen_links, url_blacklist):
    if source not in results:
        results[source] = []

    rss_url = "https://cert.europa.eu/publications/threat-intelligence-rss"
    ...
    for entry in feed.entries:
        ...
        first_p = re.sub(r"Additional information on any item in this Brief can be provided upon request\.", "", first_p)
        first_p = re.sub(r"\..*TLP:CLEAR\.", ".", first_p)
